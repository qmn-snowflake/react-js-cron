...
function DynamicSettings() {
  ...
  var _useState39 = (0, _react.useState)('@daily'),
      _useState40 = _slicedToArray(_useState39, 2),
      defaultValue = _useState40[0],
      setDefaultValue = _useState40[1];

  var _useState41 = (0, _react.useState)(false),
      _useState42 = _slicedToArray(_useState41, 2),
      leadingZero = _useState42[0],
      setLeadingZero = _useState42[1];

  var _useState43 = (0, _react.useState)(true),
      _useState44 = _slicedToArray(_useState43, 2),
      periodicityOnDoubleClick = _useState44[0],
      setPeriodicityOnDoubleClick = _useState44[1];

  var _useState45 = (0, _react.useState)('multiple'),
      _useState46 = _slicedToArray(_useState45, 2),
      mode = _useState46[0],
      setMode = _useState46[1];
  ...
  var _useState49 = (0, _react.useState)(),
      ...
      error = _useState50[0],
      onError = _useState50[1];

  var _useState51 = (0, _react.useState)('fill-with-every'),
      _useState52 = _slicedToArray(_useState51, 2),
      clearButtonAction = _useState52[0],
      setClearButtonAction = _useState52[1];
...
function ReadOnlyInput() {
  ...
  var _useState53 = (0, _react.useState)(defaultValue),
      _useState54 = _slicedToArray(_useState53, 2),
      value = _useState54[0],
      setValue = _useState54[1];
...
function ClearButtonEmptyValue() {
  ...
  var _useState75 = (0, _react.useState)(defaultValue),
      _useState76 = _slicedToArray(_useState75, 2),
      value = _useState76[0],
      setValue = _useState76[1];
